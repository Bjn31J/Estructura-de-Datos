...
public class calculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        calcular.setBackground(new java.awt.Color(0, 0, 204));
        calcular.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
    ...
    private void calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularActionPerformed
        ...
        float R1 =Float.parseFloat( r1.getText());
        float R2 =Float.parseFloat( r2.getText());
        float R3 =Float.parseFloat( r3.getText());
        
        float detA=((X1)*(Y2)*(Z3)+(Y1)*(Z2)*(X3)+(Z1)*(X2)*(Y3))-
                ((Y1)*(X2)*(Z3)+(X1)*(Z2)*(Y3)+(Z1)*(Y2)*(X3));
        
        float detAx=((R1)*(Y2)*(Z3)+(Y1)*(Z2)*(R3)+(Z1)*(R2)*(Y3))-
                ((Y1)*(R2)*(Z3)+(R1)*(Z2)*(Y3)+(Z1)*(Y2)*(R3));
        
        float detAy=((X1)*(R2)*(Z3)+(R1)*(Z2)*(X3)+(Z1)*(X2)*(R3))-
                ((R1)*(X2)*(Z3)+(X1)*(Z2)*(R3)+(Z1)*(R2)*(X3));
        
         float detAz=((X1)*(Y2)*(R3)+(Y1)*(R2)*(X3)+(R1)*(X2)*(Y3))-
                ((Y1)*(X2)*(R3)+(X1)*(R2)*(Y3)+(R1)*(Y2)*(X3));
  
         float x= detAx/detA;
         float y= detAy/detA;
         float z= detAz/detA;
        
         String resultado = "X: "+x+"\nY: "+y+"\nZ: "+z;
   ...
   /* private boolean validar() {
        if(x1==null &x2==null &x3=null &r1=null&r2&r3&y1&y2&y3&z1&z2&z3==null){
