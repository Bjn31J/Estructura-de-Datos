         ...
         if(nodo==null)
             ...
             if(numero<nodo.numN)
                ...
                nodo.der=eliminar(nodo.der,numero);
                 ...
                 nodo.numN=anterior.numN;
                 nodo.izq=eliminar(nodo.izq,anterior.numN);
             }
...
public void escribeArbol(){
    ...
    private void llenaenOrden(Nodo aux,int nivel,int pos,int inc) {
        if(aux !=null){
            ...
            matriz[nivel][pos]=String.valueOf(aux.numN+" "+aux.getFe());
